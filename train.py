...
def main():
    ...
    parser.add_argument('--use_bi_gru', default=false, type=bool,
                        help='bi_gru.')
    parser.add_argument('--layers', default=5, type=int,
                        help='Number of routing layers (R)')
    parser.add_argument('--alpha', default=0.4, type=float,
                        help='Co-occurrence controlled parameter (α_r).')
    parser.add_argument('--top_p', default=15, type=int,
                        help='Top-p sampling parameter.')
    parser.add_argument('--window_sizes', nargs='+', type=int, default=[1, 2, 3, 4, 5],
                        help='List of window sizes for convolution layers.')
    parser.add_argument('--steps', nargs='+', type=int, default=[1,1,2,2,3],
                        help='Step sizes for different layers.')
    parser.add_argument('--z1', default=0.4, type=int,
                        help='Task 1 remaining areas within the normal distribution (z_1)')
    parser.add_argument('--z2', default=0.2, type=int,
                        help='Task 2 remaining areas within the normal distribution (z_2).')
    parser.add_argument('--epsilon', default=-1e-9, type=int,
                        help='Small negative number (ε).')
